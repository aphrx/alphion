        ...
        <View style={styles.tasksWrapper}>
          <View style={styles.newWorkoutTile}>
            <View style={styles.cardContainer}>
                <ImageBackground source={backgrounds[selectedColor]} style={styles.imageBackground} imageStyle={{ borderRadius: 20}}>
                  ...
                  <View style={styles.imageOptions}>
                    <TileOptionButton key={selectedColor} opt={0} selected={selectedColor} onPress={onSelectColor}/>
                    <TileOptionButton key={selectedColor+1} opt={1} selected={selectedColor} onPress={onSelectColor}/>
                  </View>
                </ImageBackground>
            </View>
